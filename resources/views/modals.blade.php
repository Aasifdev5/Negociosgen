...
$toSelectProjectUsers = $workspace->users;
$toSelectProjectClients = $workspace->clients;
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select class="form-select selectLruser" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>" name="user_id">
                            @isset($users)
                    ...
                    <div class="col-12 leaveVisibleToDiv mb-3">
                        <select class="form-control js-example-basic-multiple" name="visible_to_ids[]" multiple="multiple" data-placeholder="<?= get_label('select_users_leave_visible_to', 'Select Users Leave Visible To') ?>">
                            @isset($users)
                            @foreach ($users as $user)
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="mt-2">
                            <a href="javascript:void(0);" class="openCreateContractTypeModal"><button type="button" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title=" <?= get_label('create_contract_type', 'Create contract type') ?>"><i class="bx bx-plus"></i></button></a>
                ...
                <div class="row">
                    ...
                    ?>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <select class="form-control selectTaskProject" name="project" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
                                    <option value=""></option>
                                    @isset($projects)
                                    @foreach($projects as $project)
