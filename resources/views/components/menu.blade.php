...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme menu-container">
    <div class="app-brand demo">
        <a href="/home" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="{{asset($general_settings['full_logo'])}}" width="200px" height="70px" alt="" />
            </span>
    ...
    <div class="btn-group dropend px-2">
        ...
        <ul class="dropdown-menu">
            ...
            <li>
    <a class="dropdown-item" href="/workspaces/switch/{{$workspace->id}}">
        <?= $checked ?>
        {{$workspace->title}}
        <?= $workspace->is_primary ? ' <span class="badge bg-success">'.get_label('primary', 'Primary').'</span>' : ''?>
            ...
            <li><span data-bs-toggle="modal" data-bs-target="#createWorkspaceModal"><a class="dropdown-item" href="javascript:void(0);"><i class='menu-icon tf-icons bx bx-plus text-warning'></i><?= get_label('create_workspace', 'Create workspace') ?></a></span></li>
            @endif
            @if ($user->can('edit_workspaces'))
            <li><a class="dropdown-item edit-workspace" href="javascript:void(0);" data-id="{{session()->get('workspace_id')}}"><i class='menu-icon tf-icons bx bx-edit text-primary'></i><?= get_label('edit_workspace', 'Edit workspace') ?></a></li>
            @endif
            @endif
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('projects') || Request::is('tags/*') || Request::is('projects/*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('projects') || Request::is('projects/*') && !Request::is('projects/favorite') && !Request::is('projects/list/favorite') ? 'active' : '' }}">
                    <a href="/{{getUserPreferences('projects', 'default_view')}}" class="menu-link">
                ...
                <li class="menu-item {{ Request::is('projects/favorite') || Request::is('projects/list/favorite') ? 'active' : '' }}">
                    <a href="/{{getUserPreferences('projects', 'default_view')}}/favorite" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('tasks') || Request::is('tasks/*') ? 'active' : '' }}">
            <a href="/{{getUserPreferences('tasks', 'default_view')}}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('estimates-invoices') || Request::is('estimates-invoices/*') || Request::is('taxes') || Request::is('payment-methods') || Request::is('payments') || Request::is('units') || Request::is('items') || Request::is('expenses') || Request::is('expenses/*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ Request::is('expenses/expense-types') ? 'active' : '' }}">
                    <a href="/expenses/expense-types" class="menu-link">
