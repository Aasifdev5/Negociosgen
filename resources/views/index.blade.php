                ...
                <div class="col-12">
                    ...
                    <div class="course-intro" style="margin-bottom: 30px;">
                        <div class="video-container" style="position: relative;">
                            ...
                            <img src="{{ asset($row->coach_thumbnail) }}" class="thumbnail img-fluid"
                                alt="Coach Thumbnail" />
                        ...
                        <h1 class="mt-3 text-center" style="color: #EDEDED;">Coach : {{ $row->coach_name }}</h1>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 order-2 order-md-1 text-center text-md-start" style="padding-bottom: 10px;">
                ...
                <div class="mb-4 d-flex align-items-start">
                    ...
                    <div class="text-light">
                        {{ __('Premios e incentivos para miembros que hagan crecer su red de asociados.') }}
                    </div>
                </div>

                <!-- Join Button -->
                <div>
                    <a href="{{ url('membership') }}" class="btn btn-primary btn-lg fw-bold">{{ __('Únete ahora') }}</a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12 order-1 order-md-2" style="padding-bottom: 10px;">
                <div class="video-container">
                    ...
                    <div class="embed-responsive" style="display: none;">
                        <video class="embed-responsive-item" controls>
                            <source src="{{ asset('assets/VID-20250118-WA0002.mp4') }}" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                    </div>
                </div>
