                    ...
                    <div class="accordion" id="termsAccordion">
                                ...
                                <div class="card-body">
                                    <div class="bienvenido-al-sitio-web-de-gen-wrapper">
                                        <div class="bienvenido-al-sitio-container">
                                            <span>Bienvenido al sitio web de GEN (</span>
                                            <a class="wwwnegociosgencom" href="http://www.negociosgen.com"
                                                target="_blank">www.negociosgen.com</a>
                                            <span>). Al acceder y utilizar este sitio, usted acepta cumplir y estar sujeto a
                                                los siguientes términos de uso. Si no está de acuerdo con estos términos, le
                                                pedimos que no utilice nuestro sitio. Estos términos pueden ser actualizados
                                                periódicamente, y la versión más reciente estará disponible en esta
                                                página.</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseConditions" class="collapse" aria-labelledby="headingConditions"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>El uso de este sitio web está sujeto a las condiciones de uso descritas a
                                        continuación. Le recomendamos que revise estas condiciones periódicamente, ya que
                                        cualquier modificación entrará en vigor inmediatamente después de su publicación en
                                        el sitio. Su uso continuo del sitio implica que acepta estas modificaciones.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseUsage" class="collapse" aria-labelledby="headingUsage"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>Este sitio web está diseñado exclusivamente para residentes de Bolivia. El contenido
                                        del sitio se proporciona con el propósito de informar sobre los productos y
                                        oportunidades de negocio de GEN. Usted se compromete a utilizar el sitio únicamente
                                        para fines lícitos y de acuerdo con estas condiciones de uso.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseRegistration" class="collapse" aria-labelledby="headingRegistration"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>Para acceder a ciertas partes del sitio, es posible que deba registrarse y crear una
                                        cuenta. Usted es responsable de mantener la confidencialidad de su contraseña y de
                                        todas las actividades realizadas bajo su cuenta. Si sospecha de un uso no autorizado
                                        de su cuenta, debe notificarnos de inmediato.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseIntellectual" class="collapse" aria-labelledby="headingIntellectual"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>Todos los derechos de propiedad intelectual sobre el contenido del sitio, incluidos
                                        pero no limitados a textos, gráficos, logotipos, imágenes y software, son propiedad
                                        de GEN o de sus licenciantes. No está permitido reproducir, distribuir, modificar o
                                        utilizar los materiales del sitio sin el consentimiento previo por escrito de GEN.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseLinks" class="collapse" aria-labelledby="headingLinks"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>Este sitio puede contener enlaces a otros sitios web. GEN no se hace responsable del
                                        contenido de esos sitios, ni de las políticas de privacidad de los mismos. La
                                        inclusión de cualquier enlace no implica respaldo por parte de GEN de dichos sitios.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseLiability" class="collapse" aria-labelledby="headingLiability"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>GEN no será responsable de ningún daño directo, indirecto, incidental o consecuente
                                        que resulte del uso o la incapacidad de uso del sitio. Esto incluye, pero no se
                                        limita a, la pérdida de beneficios, datos o uso de dinero.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseModifications" class="collapse" aria-labelledby="headingModifications"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>GEN se reserva el derecho de modificar o descontinuar el sitio o cualquier parte del
                                        mismo en cualquier momento y sin previo aviso. No seremos responsables ante usted ni
                                        ante terceros por cualquier modificación o descontinuación del sitio.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseLaw" class="collapse" aria-labelledby="headingLaw"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>Estos términos de uso se regirán e interpretarán de acuerdo con las leyes del Estado
                                        Plurinacional de Bolivia. Cualquier disputa que surja en relación con estos términos
                                        será resuelta por los tribunales competentes de Bolivia.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 transparent-card">
                            ...
                            <div id="collapseGeneral" class="collapse" aria-labelledby="headingGeneral"
                                data-bs-parent="#termsAccordion">
                                <div class="card-body">
                                    <p>Si alguna disposición de estos términos se considera inválida o inaplicable, dicha
                                        disposición se interpretará de manera consistente con la ley aplicable, y las
                                        disposiciones restantes permanecerán en pleno vigor y efecto.</p>
                                </div>
                            </div>
                        </div>
