                ...
                <div class="col-lg-10">
                    ...
                    <div class="mb-3 mt-2">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('status_not_active', 'Your account is currently inactive. Please contact the admin for assistance.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('forgot_password_email_info','This template will be used for the email notification sent to users/clients to reset their password if they have forgotten it.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('project_assignment_email_info','This template will be used for the email notification sent to users/clients when they are assigned a project.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('task_assignment_email_info','This template will be used for the email notification sent to users/clients when they are assigned a task.',Session::get('locale')) !!}
                            {!! create_label('task_assignment_email_will_not_sent','If Deactive, task assignment email won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('workspace_assignment_email_info','This template will be used for the email notification sent to users/clients when they are added to a workspace.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('meeting_assignment_email_info','This template will be used for the email notification sent to users/clients when they are added to a meeting.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('project_assignment_sms_info','This template will be used for the SMS notification sent to users/clients when they are assigned a project.',Session::get('locale')) !!}
                            {!! create_label('project_assignment_sms_will_not_sent','If Deactive, project assignment SMS won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_assignment_sms_info','This template will be used for the SMS notification sent to users/clients when they are assigned a task.',Session::get('locale')) !!}
                            {!! create_label('task_assignment_sms_will_not_sent','If Deactive, task assignment SMS won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('workspace_assignment_sms_info','This template will be used for the SMS notification sent to users/clients when they are added to a workspace.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('meeting_assignment_sms_info','This template will be used for the SMS notification sent to users/clients when they are added to a meeting.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('acc_crea_email_enabled_inf', 'As Account Creation Email Status Is Active, Please Ensure Email Settings Are Configured and Operational (Not Applicable If the Client Is for Internal Purposes).',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('leave_editor_access_info', 'Like Admin, Selected Users Will Be Able to Update and Create Leaves for Other Members.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('roles_can_set_status_info', 'Including Admin and Roles with All Data Access Permission, Users/Clients Under Selected Role(s) Will Have Permission to Set This Status.',Session::get('locale')) !!}
                            {!! create_label('allowed_roles', 'Allowed Roles',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('roles_can_set_status_info_1', 'Including Admin and Roles with All Data Access Permission, Roles That Can Set This Status.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('on_partial_leave_day_after_tomorow', 'On partial leave from day after tomorrow',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('leave_visible_to_info', 'Disabled: Requestee, Admin, and Leave Editors, along with selected users, will be able to know when the requestee is on leave. Enabled: All team members will be able to know when the requestee is on leave.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_visible_to_info_1', 'Including the requestee, admin, and leave editors, users who will be able to know when the requestee is on leave (not applicable if visible to all).',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('leave_request_creation_email_info', 'This Template Will Be Used for the Email notification sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_creation_email_will_not_sent', 'If Deactive, Leave Request Creation Email Won\'t be Sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('leave_request_status_updation_email_will_not_sent', 'If Deactive, Leave Request Status Updation Email Won\'t be Sent',Session::get('locale')) !!}
                            {!! create_label('leave_request_creation_sms_info', 'This Template Will Be Used for the SMS notification sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_creation_sms_will_not_sent', 'If Deactive, Leave Request Creation SMS Won\'t be Sent',Session::get('locale')) !!}
                            {!! create_label('leave_request_status_updation_sms_info', 'This Template Will Be Used for the SMS notification sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_status_updation_sms_will_not_sent', 'If Deactive, Leave Request Status Updation SMS Won\'t be Sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('save_column_visibility_alert', 'Are You Want to Save Column Visibility?',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('project','Project',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('project_status_updation_email_will_not_sent', 'If Deactive, Project Status Updation Email won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task','Task',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('project_status_updation_sms_will_not_sent', 'If Deactive, Project Status Updation SMS won\'t be Sent',Session::get('locale')) !!}
                            {!! create_label('task_status_updation_sms_info', 'This Template Will Be Used for the SMS notification sent to the Users/Clients Upon the Status Updation of a Task.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_status_updation_sms_will_not_sent', 'If Deactive, Task Status Updation SMS won\'t be Sent',Session::get('locale')) !!}
                            {!! create_label('no_projects_view_permission', 'You don\'t have permission to view projects.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('no_tasks_view_permission', 'You don\'t have permission to view tasks.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('project_assignment_whatsapp_info', 'This template will be used for the whatsApp notification sent to users/clients when they are assigned a project.',Session::get('locale')) !!}
                            {!! create_label('project_assignment_whatsapp_will_not_sent', 'If Deactive, project assignment whatsapp notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_assignment_whatsapp_info', 'This template will be used for the whatsapp notification sent to users/clients when they are assigned a task.',Session::get('locale')) !!}
                            {!! create_label('task_assignment_whatsapp_will_not_sent', 'If Deactive, task assignment whatsapp notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('task_status_updation_whatsapp_will_not_sent', 'If Deactive, Task Status Updation Whatsapp Notification won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('workspace_assignment_whatsapp_info', 'This template will be used for the whatsapp notification sent to users/clients when they are added to a workspace.',Session::get('locale')) !!}
                            {!! create_label('workspace_assignment_whatsapp_will_not_sent', 'If Deactive, workspace assignment whatsapp notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('meeting_assignment_whatsapp_info', 'This template will be used for the whatsapp notification sent to users/clients when they are added to a meeting.',Session::get('locale')) !!}
                            {!! create_label('meeting_assignment_whatsapp_will_not_sent', 'If Deactive, meeting assignment whatsapp notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_creation_whatsapp_info', 'This Template Will Be Used for the Whatsapp notification sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                            {!! create_label('leave_request_creation_whatsapp_will_not_sent', 'If Deactive, Leave Request Creation Whatsapp Notification Won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_status_updation_whatsapp_info', 'This Template Will Be Used for the Whatsapp notification sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.',Session::get('locale')) !!}
                            {!! create_label('leave_request_status_updation_whatsapp_will_not_sent', 'If Deactive, Leave Request Status Updation Whatsapp Notification Won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('whatsapp','WhatsApp',Session::get('locale')) !!}
                            {!! create_label('important_settings_for_whatsapp_notification_feature_to_be_work', 'Important settings for WhatsApp notification feature to be work.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('project_assignment_system_info', 'This template will be used for the system notification sent to users/clients when they are assigned a project.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('project_assignment_system_will_not_sent', 'If Deactive, project assignment system notification won\'t be sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('project_status_updation_system_will_not_sent', 'If Deactive, Project Status Updation System Notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('task_assignment_system_info', 'This template will be used for the system notification sent to users/clients when they are assigned a task.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_assignment_system_will_not_sent', 'If Deactive, task assignment system notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('task_status_updation_system_info', 'This Template Will Be Used for the System notification sent to the Users/Clients Upon the Status Updation of a Task.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_status_updation_system_will_not_sent', 'If Deactive, Task Status Updation system notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('workspace_assignment_system_info', 'This template will be used for the system notification sent to users/clients when they are added to a workspace.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('workspace_assignment_system_will_not_sent', 'If Deactive, workspace assignment system notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('meeting_assignment_system_info', 'This template will be used for the system notification sent to users/clients when they are added to a meeting.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('meeting_assignment_system_will_not_sent', 'If Deactive, meeting assignment system notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('leave_request_creation_system_info', 'This Template Will Be Used for the System notification sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_creation_system_will_not_sent', 'If Deactive, Leave Request Creation system notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('leave_request_status_updation_system_info', 'This Template Will Be Used for the System notification sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_status_updation_system_will_not_sent', 'If Deactive, Leave Request Status Updation System Notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('system', 'System',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('please_enter_title','Please enter title',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('drag_and_drop_update_zip_here', 'Drag & Drop System Update / Plugin\'s .zip file Here',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('only_one_file_can_be_uploaded_at_a_time', 'Only 1 file can be uploaded at a time',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('team_member_on_leave_alert_email_will_not_sent', 'If Deactive, Team Member on Leave Alert Email Won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('team_member_on_leave_alert_system_info', 'This template will be used for the system notification sent to team members upon approval of a leave request, informing them about the absence of the requestee.',Session::get('locale')) !!}
                        {!! create_label('team_member_on_leave_alert_system_will_not_sent', 'If Deactive, Team Member on Leave Alert System Notification Won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('team_member_on_leave_alert_sms_info', 'This template will be used for the SMS notification sent to team members upon approval of a leave request, informing them about the absence of the requestee.',Session::get('locale')) !!}
                        {!! create_label('team_member_on_leave_alert_sms_will_not_sent', 'If Deactive, Team Member on Leave Alert SMS Notification Won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('team_member_on_leave_alert_whatsapp_info', 'This template will be used for the WhatsApp notification sent to team members upon approval of a leave request, informing them about the absence of the requestee.',Session::get('locale')) !!}
                            {!! create_label('team_member_on_leave_alert_whatsapp_will_not_sent', 'If Deactive, Team Member on Leave Alert WhatsApp Notification Won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('user_acc_crea_email_enabled_inf', 'As Account Creation Email Status Is Active, Please Ensure Email Settings Are Configured and Operational.',Session::get('locale')) !!}
                            {!! create_label('client_require_email_verification_info', 'If Yes is selected, client will receive a verification link via email. Please ensure that email settings are configured and operational.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('user_require_email_verification_info', 'If Yes is selected, user will receive a verification link via email. Please ensure that email settings are configured and operational.',Session::get('locale')) !!}
                            {!! create_label('internal_client_info', 'Select this option if you want to create a client for internal use only, without granting account access to the client.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('account_internal_purpose', 'Your account is recognized for internal purposes, Please contact the admin for assistance.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('email_not_configured_info', 'Email settings are not configured, which is required for the email verification process. Please contact the admin for assistance.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('primary_workspace', 'Primary Workspace',Session::get('locale')) !!}
                            {!! create_label('primary_workspace_not_set_info', 'Signup is enabled, but primary workspace is not set, which is required for signup.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('click_to_set_now', 'Click here to set it now',Session::get('locale')) !!}
                            {!! create_label('primary_workspace_not_set_info_signup', 'Primary workspace is not set, which is required for signup. Please contact the admin for assistance.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('enable_disable_signup', 'Enable/Disable Signup',Session::get('locale')) !!}
                            {!! create_label('enable_disable_signup_info', 'If disabled, team member or client will not be able to create an account by themselves.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
