                    ...
                    <div class="col-md-12">
                        <div class="card" style="background: #fff">
                            <div class="card-header">
                                <h2>{{ __('Lista video de consejos de éxito') }}</h2>
                                <a href="{{ route('success.create') }}" class="btn btn-success btn-sm pull-right">
                                    <i class="fa fa-plus"></i> {{ __('Añadir video de consejos de éxito') }}
                                </a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="advance-1" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Success Tips provider</th>
                                                <th>Tips video title</th>
                                                <th>Descripción</th>
                                                <th>Portada</th>
                                                <th>Acción</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            @foreach ($SuccessTipss as $course)
                                                <tr class="removable-item">
                                                    ...
                                                    <td>
                                                        <div class="action__buttons">
                                                            <a href="{{ route('success.edit', [$course->id]) }}" title="Editar"
                                                            ...
                                                            <a href="javascript:void(0);" title="Eliminar"
                                                               ...
                                                               data-toggle="tooltip" data-url="{{ route('success.delete', $course->id) }}">
