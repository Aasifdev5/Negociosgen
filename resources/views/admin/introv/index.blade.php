                    ...
                    <div class="col-md-12">
                        <div class="card" style="background: #fff">
                            <div class="card-header">
                                <h2>{{ __('Lista Vídeo de introducción') }}</h2>
                                <a href="{{ route('intro.create') }}" class="btn btn-success btn-sm pull-right">
                                    <i class="fa fa-plus"></i> {{ __('Añadir Vídeo de introducción') }}
                                </a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="advance-1" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Vídeo de introducción provider</th>
                                                <th>Vídeo de introducción title</th>
                                                <th>Descripción</th>
                                                <th>Portada</th>
                                                <th>Acción</th>
                                            </tr>
                                                ...
                                                <tr class="removable-item">
                                                    ...
                                                    <td>
                                                        <div class="action__buttons">
                                                            <a href="{{ route('intro.edit', [$course->id]) }}" title="Editar"
                                                            ...
                                                            <a href="javascript:void(0);" title="Eliminar"
                                                               ...
                                                               data-toggle="tooltip" data-url="{{ route('intro.delete', $course->id) }}">
