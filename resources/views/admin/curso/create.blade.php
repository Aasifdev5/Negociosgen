                            ...
                            <div class="form-vertical__item bg-style">
                                ...
                                <form id="courseForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="courseTitle" name="title" placeholder="Título" value="{{ old('title') }}" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="coursePrice" name="price" placeholder="$0.00" value="{{ old('price') }}" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url" class="form-control" id="videoLink" name="video_link" placeholder="youtube.com" value="{{ old('video_link') }}" required>
