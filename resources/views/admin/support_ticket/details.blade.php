                                            ...
                                            <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                                                <div class="ticket-details-left-part">
                                                    <div class="ticket-replies-wrap mb-20 ticket-details-box radius-4 p-20">
                                                        ...
                                                        @forelse($ticketMessages as $ticketMessage)
                                                            <div class="ticket-reply-item
                                                                @if ($ticketMessage->reply_admin_user_id) ticket-reply-item-staff
                                                                @elseif($ticketMessage->sender_user_id) ticket-reply-item-student
                                                                @endif">
                                                                    ...
                                                                    @if ($ticketMessage->file)
                                                                        <div class="upload-img-box mb-25">
                                                                            <a href="{{ getImageFile($ticketMessage->file) }}" target="_blank">
                                                                                <img src="{{ getImageFile($ticketMessage->file) }}" alt="img">
                                                                            </a>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                    ...
                                                    <div class="ticket-details-reply-form-box ticket-details-box radius-4 p-20">
                                                        ...
                                                        <form action="{{ route('support-ticket.admin.messageStore') }}" method="post" enctype="multipart/form-data" id="ticketReplyForm">
                                                            @csrf
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb-15">
                                                                    <h6 class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Upload Your File') }}</h6>
                                                                ...
                                                                <div class="col-md-12 mb-20">
                                                                    ...
                                                                    <p class="font-14 placeholder-color mb-0">
                                                                        {{ __('Valid File Type') }}: jpg, jpeg, gif, png and {{ __('File size max') }}: 10 MB
                                                                    </p>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="ticket-details-right-part ticket-details-box radius-4 p-20">
                                                    <div class="ticket-details-box-title d-flex justify-content-between align-items-center mb-20">
                                                        ...
                                                        <div class="ticket-info-right-status d-flex align-items-center">
                                                            ...
                                                            <div class="ticket-status-box radius-3 {{ $ticket->status == 1 ? 'bg-green' : 'bg-deep-orange' }} text-white font-14">
                                                    ...
                                                    <div class="ticket-info-bottom-box">
                                                        <div class="ticket-info-content">
                                                            ...
                                                            <p>{{ __('Last Response') }}: {{ $last_message->created_at ?? 'N/A' }}</p>
                                                        </div>
                                                    </div>
