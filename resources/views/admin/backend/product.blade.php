                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="short_desc" id="editor" class="form-control " rows="4">{{ old('title',$datalist->short_desc) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group tpeditor">
                                                                ...
                                                                <textarea name="description" id="summernote" class="form-control" rows="7">{{ old('title',$datalist->description) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
