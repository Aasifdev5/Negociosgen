                        ...
                        <div class="col-md-12">
                            <div class="form-vertical__item bg-style">
                                <div class="item-top mb-30">
                                    <h2>{{ __('Añadir nuevo evento') }}</h2>
                                </div>
                                <form id="courseForm" action="{{ route('events.store') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control summernote" id="description" name="description" rows="3" placeholder="Escribe la descripción del curso">{{ old('description') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url" class="form-control" id="link" name="link" placeholder="yoursite.com" value="{{ old('link') }}">
                                        <small id="linkError" class="text-danger"></small>
                                    </div>
                                    <button type="submit" class="btn btn-primary w-100" style="background-color: #00f;">Publicar Evento</button>
                                </form>
                                                ...
                                                success: function(response) {
                                                    if (response.success) {
                                                        ...
                                                        Swal.fire({
                                                            icon: 'error',
                                                            title: 'Error',
                                                            text: response.message || 'No se pudo publicar el evento.',
                                                        });
                                                    }
                                                },
                                                error: function(xhr) {
