                ...
                <div class="row admin-dashboard-translate-your-language-page">
                    <div class="col-md-12">
                        <div class="card-header">
                            <button class="btn btn-success btn-sm mb-2" type="button" data-bs-toggle="modal"
                                            ...
                                            @foreach($translators as $key => $value)
                                                <tr>
                                                    ...
                                                    <td class="text-end col-1">
                                                        <button type="button" disabled class="language-update btn btn-sm btn-primary">{{__('Update')}}</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
    ...
    $('.addmore').on('click', function (e) {
        ...
        let html = `
            <tr>
                ...
                <td class="text-end col-1">
                    <button type="button" class="language-update btn btn-sm btn-primary">{{__('Update')}}</button>
                </td>
            </tr>
        `;
        $('#append').prepend(html);
                ...
                <form action="{{ route('language.import') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input__group mb-30">
                            ...
                            <select name="import" class="form-control select2" id="inputGroupSelect02">
                        ...
                        <br>
                        <div>
                            <button type="submit" class="btn btn-success btn-sm">{{ __('Import') }}</button>
                        </div>
                    </div>
                </form>
            </div>
