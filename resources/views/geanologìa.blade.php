                                ...
                                <li>
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modalPerson"
                                        ...
                                        <p class="card-text d-flex justify-content-between">
                                            <span class="me-3">Referidos:
                                                {{ \App\Models\User::where('refer', $user_session->id)->count() }}</span>
                                            ...
                                            @foreach ($user_session->children as $child)
                                                <li>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modalPerson"
                                                        ...
                                                        data-id="{{ $child->id }}" data-sales="{{ $child->balance }}"
                                                        ...
                                                        @if (!empty($child->profile_photo))
                                                            ...
                                                            <span class="badge bg-primary"
                                                                ...
                                                                {{ $child->level }}</span> <!-- Display Level -->
                                                        @else
                                                            <img src="{{ asset('149071.png') }}" alt="Profile Image"
                                                                style="width: 60px; height: 60px;" />
                                                            <br>
                                                        ...
                                                        <p class="card-text d-flex justify-content-between">
                                                            <span class="me-3">Referidos:
                                                                {{ \App\Models\User::where('refer', $child->id)->count() }}</span>
                                                                ...
                                                                <li>
                                                                    <a href="#" data-bs-toggle="modal"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span class="me-3">Referidos:
                                                                                {{ \App\Models\User::where('refer', $grandchild->id)->count() }}</span>
                                                                            <span>{{ __('Ventas') }}:
                                                                                Bs{{ $grandchild->balance }}</span>
                                                                            ...
                                                                            @foreach ($grandchild->children as $greatGrandchild)
                                                                                <li>
                                                                                    <a href="#"
                                                                                        ...
                                                                                        data-level="{{ $greatGrandchild->level }}"
                                                                                        class="p-3">
                                                                                        ...
                                                                                        <p
                                                                                            class="card-text d-flex justify-content-between">
                                                                                            <span class="me-3">Referidos:
                                                                                                {{ \App\Models\User::where('refer', $greatGrandchild->id)->count() }}</span>
                                                                                            <span>{{ __('Ventas') }}:
                                                                                                Bs{{ $greatGrandchild->balance }}</span>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background: #000">
                <div class="modal-header">
                    <h5 class="modal-title text-white" id="modalPersonLabel">{{ __('Perfil del Miembro') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex flex-column align-items-center mb-4">
                        <img id="memberPhoto" class="rounded-circle mt-3" src="" alt="Member Photo"
                    ...
                    <div class="row text-center mb-3 g-3">
                        ...
                        <div class="col-sm-6 text-white"
                            ...
                            <div>{{ __('Referidos Activos') }}</div>
                        </div>
                    </div>


                    <!-- Sales Table -->
                    <h5 class="mt-4 text-white">{{ __('Últimas ventas') }}</h5>
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                            const salesRows = data.map((sale, index) => {
                                ...
                                const commission = parseFloat(sale.commission).toFixed(
                                    2);
                                return `
                            <tr>
                                <td>${index + 1}</td>
