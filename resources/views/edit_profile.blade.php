        ...
        <div class="container my-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="card mb-4"
                        style="background-color: #121212; border: 1px solid #2e2e2e; border-radius: 10px;">
                        <div class="d-flex flex-column align-items-center p-4">
                            ...
                            <form action="{{ url('update_profile') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="personal-image mb-3 text-center">
                                    ...
                                    <p style="color: #a1a1a1; font-size: 14px;">{{ $user_session->username ?? 'usuario' }}
                                    </p>
                                    <div class="d-flex justify-content-center align-items-center mt-2">
                                        ...
                                        <span class="text-light ms-2"
                                            style="font-size: 14px;">{{ $user_session->is_online == 1 ? 'En Línea' : 'Desconectado' }}</span>
                                    </div>
                                </div>

                                <div class="p-4 text-center">
                                    <p class="text-light mb-3" style="font-size: 14px;">
                                        {{ $user_session->about ?? 'Sin descripción' }}</p>
